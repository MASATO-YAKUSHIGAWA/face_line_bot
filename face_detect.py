...
def face_detect(image):
   ...
   payload = {'api_key': os.environ['FACE_API_KEY'], 'api_secret': os.environ['FACE_API_SECRET'],\
   ...
   try:
       ...
       msg = ""
       for i, f in enumerate(face_list, 1): #enumerate…連番でリスト等を出力
           msg += "{}人目の情報\n".format(i)
